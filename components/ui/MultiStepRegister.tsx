...
const MultiStepRegister = () => {
  ...
  return (
    <div className=" w-full h-screen items-center justify-center bg-linear-to-br from-zinc-950 via-zinc-900 to-black flex flex-col">
      {/* Header */}
                ...
                {step < 3 && (
                  <div
                    className={`flex-1 h-1 mx-2 transition-all ${
                      currentStep > step ? "bg-green-500" : "bg-zinc-800"
                    }`}
                  />
                )}
              </div>
