                        ...
                        {events.map((event, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 hover:border-red-600/40 transition-all duration-300 hover:shadow-xl hover:shadow-red-600/10"
                                >
                                    <div className="grid grid-cols-1 md:grid-cols-[260px_1fr]">
                                        {/* Event Image */}
                                        <div className="relative h-56 md:h-full bg-zinc-800 overflow-hidden">
                                            <Image
                                                src={event.image}
                                                alt={event.name}
                                                fill
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                            ...
                                            {event.registrationStatus === 'REJECTED' && (
                                                <div className="sm:col-span-2 w-full px-4 py-3 bg-red-500/10 border border-red-500/30 text-red-500 rounded-lg text-sm font-medium flex items-center justify-center gap-2">
                                                    <FiX size={16} />
